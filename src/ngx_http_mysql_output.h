...
ngx_chain_t     *ngx_mysql_render_rds_header(ngx_http_request_t *,	ngx_pool_t *, ngx_uint_t, ngx_uint_t, char* errstr, ngx_uint_t, ngx_uint_t);
...
rds_col_type_t   ngx_mysql_rds_col_type(enum_field_types);
